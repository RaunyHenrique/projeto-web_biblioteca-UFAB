...
//			
//			Iterable<Curso> cursosGraduacao = cursosRepositorio.findByTipo("GRADUA«√O");
...
//			}
//			
//			Iterable<Curso> cursosPosGraduacao = cursosRepositorio.findByTipo("POSGRADUA«√O");
//			model.addAttribute("cursosPosGraduacao", cursosPosGraduacao);
//
//		}
		
		
		//agrupar por gruaÁ„o... dai no jquery, ajustar
