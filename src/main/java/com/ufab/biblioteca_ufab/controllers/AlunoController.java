...
public class AlunoController {
	...
	public String listar(Model model) {
		...
		Iterable<Curso> cursosGraduacao = cursosRepositorio.findByTipo(TipoDeCurso.GRADUA«√O);		
		model.addAttribute("cursosGraduacao", cursosGraduacao);
		
		Iterable<Curso> cursosPosGraduacao = cursosRepositorio.findByTipo(TipoDeCurso.POSGRADUA«√O);
